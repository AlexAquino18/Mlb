...
NFL: /api/odds_io?sport=nfl&from=YYYY-MM-DD&to=YYYY-MM-DD
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            from odds_io_impl import (  # noqa: E402
                DEFAULT_BOOKMAKERS,
                fetch_mlb_odds_bundle,
                fetch_nfl_odds_bundle,
            )
            ...
            sport = ((qs.get("sport") or ["mlb"])[0] or "mlb").lower()
